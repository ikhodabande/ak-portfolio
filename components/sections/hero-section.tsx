        ...
        <div className="grid lg:grid-cols-5 gap-16 w-full">
          <div className="lg:col-span-3 space-y-8">
            <div className="space-y-2">
              ...
              <h1
                ref={heroTitleRef}
                className="text-6xl font-light tracking-tight lg:text-6xl min-h-[120px]"
              >
                {/* Animated Name will be inserted here */}
                <span className="text-foreground">
                  <span className="text-foreground">
                    {language === 'fa' ? 'امیرمحمد' : 'Amirmohammad'}
                  </span>
                  <br />
                  <span className="text-muted-foreground">
                    {language === 'fa' ? 'خدابنده' : 'Khodabande'}
                  </span>
                </span>
              </h1>
            </div>
