...
export default function NewPostPage() {
  ...
  return (
    <DashboardLayout>
      <div className="p-6">
        <h1 className="text-3xl font-bold mb-6">افزودن مقاله جدید</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="title" placeholder="عنوان مقاله را وارد کنید" required />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="excerpt">خلاصه</Label>
                    <Textarea id="excerpt" placeholder="خلاصه مقاله را وارد کنید" className="min-h-[80px]" required />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="content">محتوا</Label>
                    <Textarea id="content" placeholder="محتوای مقاله را وارد کنید" className="min-h-[200px]" required />
                  </div>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle>تصویر مقاله</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="border-2 border-dashed rounded-lg p-6 flex flex-col items-center justify-center text-center">
                    ...
                    <Input type="file" className="hidden" id="post-image" accept="image/*" />
                    <Button
                      type="button"
                      variant="outline"
                      className="mt-4"
